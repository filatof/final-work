...
sudo -u "$USERNAME" sed  's|examples/client.status,examples/server2.status,examples/server3.status|/var/log/openvpn/openvpn-status.log|' /home/$USERNAME/openvpn_exporter-0.3.0/main.go
#соберем программу 
